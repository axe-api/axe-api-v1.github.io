import{_ as s,c as n,o as a,Q as p}from"./chunks/framework.ddc2bfae.js";const h=JSON.parse('{"title":"API Configs","description":"","frontmatter":{},"headers":[],"relativePath":"reference/api-configs.md","filePath":"reference/api-configs.md"}'),l={name:"reference/api-configs.md"},o=p(`<h1 id="api-configs" tabindex="-1">API Configs <a class="header-anchor" href="#api-configs" aria-label="Permalink to &quot;API Configs&quot;">​</a></h1><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-I6eQk" id="tab-AmYIQB_" checked="checked"><label for="tab-AmYIQB_">app/config.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { IApplicationConfig } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;axe-api&quot;</span><span style="color:#E1E4E8;">;</span></span>
